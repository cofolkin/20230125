			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form method="POST" id="form" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="请输入密码">
						...
						<input class="input100" type="password" id="xxx" name="pagepwd" placeholder="请输入密码">
...
<script type="text/javascript">
        ...
        ,content: '<div style="padding: 20px; line-height: 22px; background-color: #495057; color: #fff; font-weight: 300;">三楼HR佛爷<br><br>你可以在此添加任何HTML代码<br><br>默认密码：666<br><br><img src="qr-code.png" style="width:100%"</img></div>'
